...
from networks.vadepthnettinymfa import VADepthNetTiny
...
parser = argparse.ArgumentParser(description='VA-DepthNet PyTorch implementation.', fromfile_prefix_chars='@')
...
def test(params):
    ...
    model = VADepthNetTiny(max_depth=args.max_depth, prior_mean=args.prior_mean, img_size=(args.input_height, args.input_width))
